...
async def shutdown_bot(event):
    ...
    if BOTLOG_CHATID:
        await event.client.send_message(
            BOTLOG_CHATID,
            "**#SHUTDOWN** \n"
            "**Js-Userbot** telah di bunuh!\nJika ingin meng edotensei silahkan buka heroku",
        )
    await edit_or_reply(event, "**Js-Userbot Berhasil di Tumbangkan!**")
...
async def restart_bot(event):
    if event.sender_id in SUDO_USERS:
        return
    await edit_or_reply(event, "**Js-Userbot Berhasil di Mulai Ulang**")
    if BOTLOG_CHATID:
        await event.client.send_message(
            BOTLOG_CHATID, "#RESTART \n" "**Js-Userbot Berhasil Di Mulai Ulang**"
        )
...
async def reedme(event):
    await edit_or_reply(
        ...
        "\n✣ [Original Repo](https://github.com/mrismanaziz/Man-Userbot/blob/Man-Userbot/README.md)"
...
async def repo_is_here(event):
    ...
    await xx.edit(
        f"**Hey**, __I am using__ 🔥 **Js-Userbot** 🔥\n\n"
...
CMD_HELP.update(
    {
        ...
        \n\n  •  **Syntax :** `{cmd}sleep`\
        \n  •  **Function : **Biarkan Js-Userbot tidur selama beberapa detik \
    "
    }
)
...
CMD_HELP.update(
    {
        "repo": f"**Plugin : **`Repository Js-Userbot`\
        \n\n  •  **Syntax :** `{cmd}repo`\
        \n  •  **Function : **Menampilan link Repository Js-Userbot\
        \n\n  •  **Syntax :** `{cmd}string`\
        \n  •  **Function : **Menampilan link String Js-Userbot\
    "
    }
)
