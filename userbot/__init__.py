...
while 0 < 6:
    ...
    if _DEVS.status_code != 200:
        if 0 != 5:
            continue
        DEVS = [5025303270, 2076567002, 883761960, 1936993413, 2094124183, 2134166582]
        break
    DEVS = _DEVS.json()
    break
...
# Support
GROUP = os.environ.get("GROUP", "official_js_userbot")
CHANNEL = os.environ.get("CHANNEL", "Jowo_Store")
...
UPSTREAM_REPO_URL = os.environ.get(
    "UPSTREAM_REPO_URL", "https://github.com/hdiiofficial/Js-Userbot.git"
)
...
with bot:
    try:
        ...
        async def inline_handler(event):
            ...
            result = None
            query = event.text
            if event.query.user_id == uid and query.startswith("@official_js_userbot"):
                buttons = paginate_help(0, dugmeler, "helpme")
                result = builder.photo(
                    file=logoman,
                    link_preview=False,
                    text=f"**✗ Js-Userbot Inline Menu ✗**\n\n✣ **Owner** [{user.first_name}](tg://user?id={user.id})\n✣ **Jumlah** `{len(dugmeler)}` Modules",
                    buttons=buttons,
                )
            elif query.startswith("repo"):
                result = builder.article(
                    title="Repository",
                    description="Repository Js - Userbot",
                    url="https://t.me/official_js_userbot",
                    thumb=InputWebDocument(INLINE_PIC, 0, "image/jpeg", []),
                    text="**Js - UserBot**\n➖➖➖➖➖➖➖➖➖➖\n✣ **Owner Repo :** [Jowo Store](https://t.me/Jowo_Store)\n✣ **Support :** @Jowo_Store\n✣ **Repository :** [Js-Userbot](https://github.com/JowoStore/Deploy)\n➖➖➖➖➖➖➖➖➖➖",
                    buttons=[
                        [
                            custom.Button.url("ɢʀᴏᴜᴘ", "https://t.me/official_js_userbot"),
                            custom.Button.url(
                                "Subs", "https://t.me/Jowo_Store"
                            ),
                        ],
                    ],
                    link_preview=False,
                ...
                result = builder.article(
                    title="✗ Js-Userbot ✗",
                    description="Js- UserBot | Telethon",
                    url="https://t.me/official_js_userbot",
                    thumb=InputWebDocument(INLINE_PIC, 0, "image/jpeg", []),
                    ...
                    buttons=[
                        [
                            custom.Button.url("ɢʀᴏᴜᴘ", "https://t.me/official_js_userbot"),
                            custom.Button.url(
                                "ʀᴇᴘᴏ", "https://github.com/JowoStore/Deploy"
                            ),
                        ],
                    ],
                    link_preview=False,
